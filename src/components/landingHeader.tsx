...
import { imageFromTop, navAnimation, navItem } from '@/utils/animations'
...
<div className="relative z-20 bg-white lg:hidden">
      ...
      <div className="relative z-20 bg-white max-lg:hidden">
        <div className="px-6 md:px-12 lg:container lg:mx-auto lg:px-6 lg:py-4">
          <div className="flex items-center justify-between">
            <motion.div className="relative z-20 pb-1" variants={imageFromTop} initial='initial' animate='animate'>
              <Link href={ROUTES.HOME}><Image src="/images/logo.png" width={214} height={66} alt='Brix N Stones'/></Link>
            </motion.div>
            ...
            <div className="flex items-center justify-end">
              ...
              <div className="peer-checked:translate-x-0 fixed inset-0 w-[calc(100%-4.5rem)] translate-x-[-100%] bg-white shadow-xl transition duration-300 lg:border-r-0 lg:w-auto lg:static lg:shadow-none lg:translate-x-0">
                <div className="flex flex-col h-full justify-between lg:items-center lg:flex-row">
                  <motion.ul className="px-6 pt-32 text-gray-700 space-y-8 md:px-12 lg:space-y-0 lg:flex lg:space-x-12 lg:pt-0" variants={navAnimation} initial='hidden' animate='show'>
                    <motion.li variants={navItem} className="pb-2 group relative before:absolute before:inset-x-0 before:bottom-0 before:h-2 before:origin-right before:scale-x-0 before:bg-cyan-100 before:transition before:duration-200 hover:before:origin-left hover:before:scale-x-100">
                      <Link href={ROUTES.HOME}>Home</Link>
                    </motion.li>
                    <motion.li variants={navItem} className="pb-2 group relative before:absolute before:inset-x-0 before:bottom-0 before:h-2 before:origin-right before:scale-x-0 before:bg-cyan-100 before:transition before:duration-200 hover:before:origin-left hover:before:scale-x-100">
                      <Link href={ROUTES.ABOUT}>Studio & Team</Link>
